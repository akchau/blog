...
SECRET_KEY = "h15-lqp40ic+6k*r73&#9xe#s1%3@k$2hsmykugg$n-!0=#$d3"
...
ALLOWED_HOSTS = [
    ...
    "[::1]",
    "testserver",
    "www.akchau.pythonanywhere.com",
    "akchau.pythonanywhere.com",
]
...
INSTALLED_APPS = [
    ...
    "sorl.thumbnail",  # Приложение для работы с изображениями
    "rest_framework",
]
